...
const NumericOptimization = props => {
  return <>
    ...
    <p>Roughly speaking, the way this works is that the computer starts with 480,000 <strong>random values</strong> (playing the role of the four numbers <Eq>[-1,\space 3,-2,\space 4.5]</Eq> in the expression <Eq>-w + 3x - 2y + 4.5z</Eq>), and it checks how well those values manage to separate the training data. It will almost certainly be terrible.</p>
