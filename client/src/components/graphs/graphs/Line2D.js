...
handle = <<color: 'midnightblue', withLabel: false, strokeOpacity: 0>>;

PP = point(0.9, 0.75) handle;
QQ = point(0.1, 0.25) handle;
line(PP, QQ) <<color: 'midnightblue'>>;
...
PP = point(0.95, 0.21) handle;
QQ = point(0.11, 0.85) handle;
line(PP, QQ) <<color: 'midnightblue'>>;
